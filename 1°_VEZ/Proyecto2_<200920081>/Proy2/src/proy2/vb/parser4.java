...
new parser4(new Yylex4(System.in)).parse();
}
...
public static void sinta4()
{
String Reporte= "Sinta4.html";
FileWriter fw = null;
try {
...
try {
            ...
            File path = new File("Sinta4.html");
...
class CUP$parser$actions {
  ...
  /** Constructor */
  CUP$parser$actions(parser4 parser) {
    this.parser = parser;
  }
