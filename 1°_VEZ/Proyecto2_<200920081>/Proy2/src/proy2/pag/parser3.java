...
public static ArrayList titu = new ArrayList();
...
tit = "<"+tipo.get(0).toString()+">"+ titu.get(0).toString() +"</"+ tipo.get(0).toString() +">";
...
//System.out.println(tit+ns+vs+aux+vs3+"</font>");
titu.remove(0);
tipo.remove(0);
vi.clear();
tit="";
