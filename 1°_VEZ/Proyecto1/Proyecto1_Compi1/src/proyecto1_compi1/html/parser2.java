...
/** CUP v0.11a beta 20060608 generated parser2.
...
new parser2(new Yylex2(System.in)).parse();
}
...
class CUP$parser$actions {
 ...
 public static ArrayList totales= new ArrayList();
...
{
    salArch.println("<tr><td><font size="+tamfuente+">"+valores.get(p)+"</font></td>"+
