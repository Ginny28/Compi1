...
/** CUP v0.11a beta 20060608 generated parser3.
...
new parser3(new Yylex3(System.in)).parse();
}
...
Chunk ch4 = new Chunk("Fact No."+fact+" Fecha: "+fecha2);
    ...
    for(int g=j+1;j<alls.size();g=g+4)
        {
            if(alls.get(g) != "ends"){
                ...
                value = alls.get(g+2).toString();
                tab.addCell(new Paragraph(alls.get(g+3).toString()));
                tab.addCell(new Paragraph(value));
            }else{
                break;
            }
